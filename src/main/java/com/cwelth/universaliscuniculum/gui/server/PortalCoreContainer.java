...
public class PortalCoreContainer extends Container {
    ...
    public PortalCoreContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
        super(Content.PORTAL_CORE_CONTAINER.get(), windowId);
        tileEntity = (PortalCoreTE)world.getBlockEntity(pos);
